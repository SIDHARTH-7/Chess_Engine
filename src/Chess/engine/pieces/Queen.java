...
public class Queen extends Piece
{
    ...
    public Queen(final int pieceCoordinate, final Colour pieceColour)
    {
        super(PieceType.QUEEN,pieceCoordinate,pieceColour);
        ...
        possibleMoveOffsetVector[4] = new Coordinate(-1,-1);
        possibleMoveOffsetVector[5] = new Coordinate(-1,1);
        possibleMoveOffsetVector[6] = new Coordinate(-1,1);
        possibleMoveOffsetVector[7] = new Coordinate(1,1);
    }
    @Override
    ...
    {
        return new Queen(move.getDestinationCoordinate(),move.getMovedPiece().getColour());
    }
}
